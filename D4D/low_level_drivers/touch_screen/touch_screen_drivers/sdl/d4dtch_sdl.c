...
#define d4dtch_sdl_ID 1


// copilation enable preprocessor condition
// the string d4dtch_sdl_ID must be replaced by define created one line up
#if (D4D_MK_STR(D4D_LLD_TCH) == d4dtch_sdl_ID)

  // include of low level driver heaser file
  // it will be included into wole project only in case that this driver is selected in main D4D configuration file
  #include "low_level_drivers/touch_screen/touch_screen_drivers/sdl/d4dtch_sdl.h"
  /******************************************************************************
  * Macros
  ******************************************************************************/
  ...
  ******************************************************************************/
  ...
  static unsigned char D4DTCH_Init_SDL(void);
  static unsigned char D4DTCH_DeInit_SDL(void);
  static D4D_TOUCHSCREEN_LIMITS* D4DTCH_GetRawLimits_SDL(void);
  static unsigned char D4DTCH_GetPositionRaw_SDL(unsigned short *TouchPositionX,
  ...
  ******************************************************************/
  ...
  const D4DTCH_FUNCTIONS d4dtch_sdl =
  {
     D4DTCH_Init_SDL,
     D4DTCH_GetPositionRaw_SDL,
     D4DTCH_GetRawLimits_SDL,
     D4DTCH_DeInit_SDL
  };
...
#endif //(D4D_MK_STR(D4D_LLD_TCH) == d4dtch_SDL_ID)
